...
class OccasionsControllerTest < ActionController::TestCase
  ...
  test "should create occasion" do
    assert_difference('Occasion.count') do
      post :create, occasion: { desc: @occasion.desc, id: @occasion.id, name: @occasion.name, recurring: @occasion.recurring }
    end
  ...
  test "should update occasion" do
    put :update, id: @occasion, occasion: { desc: @occasion.desc, id: @occasion.id, name: @occasion.name, recurring: @occasion.recurring }
    assert_redirected_to occasion_path(assigns(:occasion))
  end
